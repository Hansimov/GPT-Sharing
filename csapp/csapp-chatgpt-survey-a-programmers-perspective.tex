...
\begin{frame}{Software Development Life Cycle}
  \centering
  \includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{./images/software-development-life-cycle.jpg}
\end{frame}
...
\begin{frame}{One Small Step for Prompt, One Giant Leap for Response}
